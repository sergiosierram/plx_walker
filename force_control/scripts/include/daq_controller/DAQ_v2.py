...
class DAQ_v2(object):
    ...
    def get_forces(self):
        ...
        ly_force = channels_info[0][0]*self.m + self.b
        lz_force = channels_info[0][1]*self.m + self.b
        ry_force = channels_info[0][2]*self.m + self.b
        rz_force = channels_info[0][3]*self.m + self.b
        #print(channels_info)

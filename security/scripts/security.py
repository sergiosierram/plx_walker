...
class PlxSecurity():
	...
	def initParameters(self):
		...
		self.lrf_top_topic = self.rospy.get_param("laser_top_topic", "/RosAria/S3Series_1_laserscan")	#ROS Parameter: topic name of upper laser
		self.lrf_floor_topic = self.rospy.get_param("sonar_env_topic", "/scan")							#ROS Parameter: topic name of front sonar
